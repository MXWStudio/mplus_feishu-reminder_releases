...
下载 [M+飞书表格中枢 0.11.1](https://github.com/MXWStudio/mplus_feishu-reminder_releases/releases/tag/hub-v0.11.1)。

- 适用系统：Windows x64。
- 安装包：`MPlus-Feishu-Hub-Setup-0.11.1-x64.exe`。
...
```powershell
Get-FileHash .\MPlus-Feishu-Hub-Setup-0.11.1-x64.exe -Algorithm SHA256
```
